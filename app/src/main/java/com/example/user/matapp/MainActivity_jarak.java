...
import com.example.user.matapp.messages.MeasurementStepMessage;
import com.example.user.matapp.messages.MessageHUB;
import com.example.user.matapp.messages.MessageListener;


public class MainActivity_jarak extends AppCompatActivity implements MessageListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_main_jarak);
    ...
    RelativeLayout.LayoutParams layout = new RelativeLayout.LayoutParams(
      (int) (0.85 * this.getResources().getDisplayMetrics().widthPixels),
      (int) (0.7 * this.getResources().getDisplayMetrics().heightPixels));

    layout.setMargins(10, (int) (0.1 * this.getResources()
      .getDisplayMetrics().heightPixels), 10, 10);
